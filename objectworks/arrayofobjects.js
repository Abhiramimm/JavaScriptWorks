...
var productsNames=products.map(p=>p.title)
...
var samsungMobiles=products.filter(p=>p.brand=="samsung" && p.price <50000).map(p=>p.title)
...
// products names available in range of 25k - 35k
